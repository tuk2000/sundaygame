...
public class PerformanceMonitor extends ToolExtender<PerformanceMonitorUIController> {
    ...
    public PerformanceMonitor() {
        uiControllerBuffer.addBuffer(PerformanceRecord.class, true,
                (BiConsumer<PerformanceMonitorUIController, PerformanceRecord>)
                        (performanceMonitorUIController, performanceRecord) -> performanceMonitorUIController.newPerformanceRecord(performanceRecord));
    }
